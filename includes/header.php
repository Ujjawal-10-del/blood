...
<!-- header -->
    ...
    <div id="home">
                ...
                <div class="container">
                    ...
                    <h1>
                        <a class="navbar-brand font-weight-bold" href="index.php">
                            <span class="text-white">BL</span><span class="text-dark">DMS</span>
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="donor-list.php">
                                    <i class="fas fa-users mr-1"></i> Donor List
                                </a>
                            </li>
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="search-donor.php">
                                    <i class="fas fa-search mr-1"></i> Search Donor
                                </a>
                            </li>
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="upcoming-events.php">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="request-received.php">
                                        <i class="fas fa-bell mr-2"></i> Request Received
                                    </a>
                                    <div class="dropdown-divider"></div>
                        ...
                        <!-- login -->
                        <a href="login.php" class="btn btn-danger ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3">
        ...
        <style>
            ...
            .isFixed .nav-link:hover,
            .isFixed .nav-item.active .nav-link {
                color: #fff !important;
                opacity: 0.8;
            }
            ...
            .dropdown-menu .dropdown-item[href*='change-password.php'] {
                white-space: nowrap;
            }
